...
func main() {
	...
	http.HandleFunc("/celular/status", handleCelularStatus)
	...
	http.HandleFunc("/skills/import", handleImportSkillsZip)
...
http.HandleFunc("/terminal/ws", handleTerminalWS)
	...
	http.HandleFunc("/drive/files", driveListFiles)
	http.HandleFunc("/drive/search", driveSearch)
	http.HandleFunc("/drive/folder/", driveFolderInfo)
	http.HandleFunc("/drive/upload", driveUpload)
	http.HandleFunc("/drive/create-folder", driveCreateFolder)
	http.HandleFunc("/drive/rename", driveRename)
	http.HandleFunc("/drive/move", driveMove)
	http.HandleFunc("/drive/delete", driveDelete)
